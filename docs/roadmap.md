...
- Bootstrap `openat/newfstatat/read/fstat/getdents64/lseek/close` (`Linux`) and `open/stat/read/fstat/getdents/seek/close` (`Ghost`, `HXNU`) VFS-backed syscall paths are online
